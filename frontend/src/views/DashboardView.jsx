...
import { fetchReferees, fetchPlayers, fetchFilters, fetchReferee, fetchPlayer } from '../api'
...
export default function DashboardView() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetchReferees(opts), fetchPlayers(opts)]).then(([r, p]) => {
      setReferees(r)
      setPlayers(p)
      setLoading(false)
    })
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.detail}>
        {!detail ? (
          <div className={styles.empty}>Select a {tab === 'referees' ? 'referee' : 'player'} to see details</div>
        ) : detail.type === 'referee' ? (
